...
class CatalogCacheRefresher
{
     ...
     */
    public function refresh(?array $only = null, bool $truncate = true): array
    {
        $steps = [
            'pharmacies' => fn () => $this->refreshPharmacies($truncate),
            'products' => fn () => $this->refreshProducts($truncate),
            'offers' => fn () => $this->refreshOffers($truncate),
            'product_pharmacies' => fn () => $this->refreshProductPharmacies($truncate),
            'categories' => fn () => $this->refreshProductCategories($truncate),
            'category_json' => fn () => $this->refreshCategoryJson($truncate),
            'promocodes' => fn () => $this->refreshPromocodes($truncate),
    ...
    public function refreshPromocodes(bool $truncate = true): int
    {
        ...
        $rowCache = DB::affectingStatement(<<<SQL
        ...
        $jsonCache = DB::affectingStatement(<<<SQL
